...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/chat-sdk-ios-automation-test/releases/download/v0.1.3/SendbirdChatSDK.zip", :sha1 => "3420847bd0f61d36608e6f407f35867a23ff109c" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
