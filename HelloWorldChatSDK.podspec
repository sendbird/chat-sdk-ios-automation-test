...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/chat-sdk-ios-automation-test/releases/download/v0.1.4/SendbirdChatSDK.zip", :sha1 => "23baec7725407bb9f5733e6d1f46c19232956c1d" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
