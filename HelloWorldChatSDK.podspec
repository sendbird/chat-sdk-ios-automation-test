...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/chat-sdk-ios-automation-test/releases/download/v0.1.2/SendbirdChatSDK.zip", :sha1 => "dd4b82ba820595c1499a6460da7aa15f7b156fdb" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
