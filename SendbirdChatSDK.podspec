...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/v0.0.5/SendbirdChatSDK.zip", :sha1 => "b22e78bea902a629a8e9b82d8df1766267503dd3" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
