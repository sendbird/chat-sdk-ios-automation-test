...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/v0.0.4/SendbirdChatSDK.zip", :sha1 => "893d5ad357077c2c1bc4cd1e15c96a7f4ae0b795" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
